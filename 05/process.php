...
//set up the query
$sql = "INSERT INTO orders (first_name, last_name, phone, address, email, chaos_croissant, midnight_muffin, existential_eclair, procrastionation_cookie, finals_week_brownie, victory_cinnamon_roll, comments) VALUES (:first_name, :last_name, :phone, :address, :email, :chaos_croissant, :midnight_muffin, :existential_eclair, :procrastionation_cookie, :finals_week_brownie, :vistory_cinnamon_roll, :comments)";
...
$procrastionationCookie = $itemsOrdered['procrastionation_cookie'] ?? 0;
